...
DICTIONARY = {
    'TR': [
        ...
        'bir sabırsızlıkla asıl hedefine varmak isteyen adımlarımı zorla zapt ederek geziniyor, '
        ...
        'Ben kocakarıyı değil kendimi öldürdüm',
        ...
        'büyük ikramiyeyi kazanmadınız mı?',
        ...
        'Bu his bir öngörü müdür? Yoksa daha fazlası mı?',
        'Yolda gidiyorsunuz kafanızı çevirip yandaki küçük parkta baktınız ve bir anda '
        'bu anı daha önce de yaşamış olduğunuzu hissettiniz',
        ...
        'Sahi, sessizlik dinlenebilir bence',
        ...
        'da insanlar birbirlerine bu kadar haksızlık yapabilir',
        ...
        'Anlattığı öyküleri bu kadar değerli kılan şeyin, onun '
        'duygusuz tavrı ve imgelerindeki zenginlik olduğunu kavradım',
